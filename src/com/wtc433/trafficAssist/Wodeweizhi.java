...
public class Wodeweizhi extends BaseBaiduMap {
	...
	public class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			if (location != null) {
				...
				MyLocationData locationDate = builder.build();
				baiduMap.setMyLocationData(locationDate);
				Toast.makeText(getApplicationContext(), "当前的位置是" + location.getAddrStr(), Toast.LENGTH_LONG).show();// 把定位数据显示到地图上
			} else {
	...
	public void init() {
		...
		BitmapDescriptor customMarker = BitmapDescriptorFactory.fromResource(R.drawable.my_loction);
		...
		back_icon = (ImageView) findViewById(R.id.backicon);
